...
function edit_collegian() {
    var url = 'index.php?r=Collegian/Edit_collegian';
    //alert(url);
    var collegian_code = $('#collegian_code').val();
    var shot_name = $('#shot_name').val();
    var collegian_name = $('#collegian_name').val();
    ...
    $.post(url, data, function (success) {
        window.location = "index.php?r=frontend/Collegian/Profile&collegian_code=" + collegian_code;
    });
}


function admin_edit_collegian() {
    var url = 'index.php?r=Collegian/Edit_collegian';
    //alert(url);
    var collegian_code = $('#collegian_code').val();
    var shot_name = $('#shot_name').val();
