...
<script type="text/javascript">
    function save_aptitude() {
        var url = "index.php?r=frontend/aptitude/save_aptitude";
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <textarea class="form-control" id="aptitude" name="aptitude" rows="5"></textarea>
    ...
    <div class="panel-footer">
        <center>
            <div class="btn btn-primary btn-sm" onclick="save_aptitude();">
