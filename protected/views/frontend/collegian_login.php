...
<html>
    <head>
        ...
        <script type="text/javascript">
            function sent_form() {
                var url = "index.php?r=frontend/collegian/do_login";
    ...
    <body class="login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="#">
                    <img src="<?php echo $path; ?>dist/img/Student-icon.png" class="img-circle" alt="User Image" width="100"/><br/>
                    <b>เข้าสู่ระบบ</b>นักศึกษา</a>
            </div><!-- /.login-logo -->
