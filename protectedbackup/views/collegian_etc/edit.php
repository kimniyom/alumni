...
<script type="text/javascript">
    function edit_collegian_etc() {
        var url = "index.php?r=frontend/collegian_etc/edit_collegian_etc";
        var collegian_code = "<?php echo $collegian_code ?>";
        var id = "<?php echo $etc['id'] ?>";
        var etc = $("#etc").val();
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <textarea class="form-control" id="etc" name="etc" rows="5"><?php echo $etc['etc']; ?></textarea>
    ...
    <div class="panel-footer">
        <center>
            <div class="btn btn-primary btn-sm" onclick="edit_collegian_etc();">
    ...
    <thead>
        <tr>
            <th colspan="3" style="text-align: right;">
                <a href="index.php?r=frontend/collegian_etc/index&collegian_code=<?php echo $collegian_code; ?>">
                    <i class="fa fa-plus"></i> เพิ่มข้อมูลอื่น ๆ
                </a>
            </th>
        </tr>
    </thead>
