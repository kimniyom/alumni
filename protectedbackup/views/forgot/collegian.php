...
<html>
    <head>
        ...
        <script type="text/javascript">
            function sent_form() {
                var url = "index.php?r=forgot/check_collegian";
                var data = {collegian_code: $("#collegian_code").val(), email: $("#email").val()};
        ...
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <div class="form-group has-feedback">
                    <input type="text" class="form-control" id="collegian_code" name="collegian_code" placeholder="รหัสนักศึกษา" required="required"/>
